...
const userReducer=(state=initialState,action)=>{
    switch(action.type){
        ...
        case "SELECTED_SKILLS":
            ...
            const index4 = prevSelectedSkills.findIndex(item=>item.value == action.payload);
            if(prevSelectedSkills.length == 10 && index4 == -1){
                toast("you can select only 10 categories",{
                    type: "warning",
                    autoClose: 3000,
                    theme: "dark",
        ...
        case "SELECTED_DESIGNATIONS":
            ...
            // let index = prevSelected.indexOf(action.payload);
            // console.log(action.payload,"%%%%%%%%%%%%%%%%%%%%%%%%%")
            const index3 = prevSelectedDes.findIndex(item=>item.value == action.payload);
        ...
        case "SELECTED_COMPANIES":
            ...
            if(!!action.payload._id){
                index1 = selectedCompanies.findIndex(item=>item.key == action.payload.userId);
                console.log(index1,"%%%%%%%%%%%%%%%%%%%%%%%%% 170")	

            }
            else{
                index1 = selectedCompanies.findIndex(item=>item.key == action.payload.key);
                console.log(index1,"%%%%%%%%%%%%%%%%%%%%%%%%% 175",action.payload,"selectedCompanies",selectedCompanies)	
            }
            console.log(selectedCompanies,"Yoooooo",action.payload)
         ...
         case "SELECTED_LOCATIONS":
                ...
                // let index = prevSelected.indexOf(action.payload);
                // console.log(action.payload,"%%%%%%%%%%%%%%%%%%%%%%%%%")
                const index2 = prevSelectedLoc.findIndex(item=>item.value == action.payload);
        ...
        // let index = prevSelected.indexOf(action.payload);
        const index = prevSelected.findIndex(item=>item.value == action.payload);
