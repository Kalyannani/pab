            ...
            <div className="jobcategory_sec_2">
                <div className="container">
                    ...
                    { location.pathname === '/categoryjobs'?
                            ...
                            category?.map(industry => {
                                return <div class="col-lg-4 col-md-6">
                                    ...
                                    <a class="company_jobs_anchor py-1 pr-2 my-1 rounded"><span>
                                        ...
                                        <span class="company_jobs_img_1_text align-self-center px-2">{industry.Category}</span>
                                        </a>
                                        </Link>
                                </div>
                            }):
                        ...
                        {
                            location.pathname === '/categoryjobs' ? null:<Link to="/categoryjobs" className='float-right All-Links'>View All Functional Areas</Link>
                        }
                        </div>
                    </div>
